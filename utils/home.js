...
// export const bookSearch = new FechData('book/search')
// export const SearchHistory = new FechData('search-history')
// export const serchCreate = new FechData('search-history/create')
